    ...
    public class AccountController : Controller
    {
       ...
       // { 
        ...
        { 
            ...
            try
            {
                string _selUser = @"Select Username,password,eactive,empdept,EMPMASTID,IMGPATH from empmast where  eactive='Yes' and  username='" + model.Username + "' and password   ='" + model.Password + "'";
                ...
                if (_dtUser.Rows.Count > 0)
                {
                    ...
                    Response.Cookies.Append("ImgPath", _dtUser.Rows[0]["IMGPATH"].ToString(), option);
