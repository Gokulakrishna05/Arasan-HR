...
{
    public class PurchaseImportQuoController : Controller
    {
        IPurchaseImportQuo PurquoService;
        private string? _connectionString;
        private readonly IWebHostEnvironment _WebHostEnvironment;
        IConfiguration? _configuratio;
        DataTransactions datatrans;
        public PurchaseImportQuoController(IPurchaseImportQuo _PurquoService, IConfiguration _configuratio, IWebHostEnvironment WebHostEnvironment)
        {
        ...
        public IActionResult PurchaseImportQuo(string id)
        {
            ...
            [HttpPost]
        public ActionResult PurchaseImportQuo(PurchaseImportQuo Cy, string id)
        {
            ...
            try
            {
                ...
                if (string.IsNullOrEmpty(Strout))
                {
                    if (Cy.ID == null)
                    {
                        TempData["notice"] = "PurchaseImportQuo Inserted Successfully...!";
                    }
                    else
                    {
                        TempData["notice"] = "PurchaseImportQuo Updated Successfully...!";
                    }
                ...
                {
                    ViewBag.PageTitle = "Edit PurchaseImportQuo";
        ...
        {
            List<PurchaseImportQuoItems> Reg = new List<PurchaseImportQuoItems>();
            ...
            for (int i = 0; i < dtUsers.Rows.Count; i++)
            {
                ...
                Reg.Add(new PurchaseImportQuoItems
                {
                    id = Convert.ToInt64(dtUsers.Rows[i]["IPURQUOTBASICID"].ToString()),
        ...
        public IActionResult ListPurchaseImportQuo()
        {
        ...
        public ActionResult SendMail(string id)
        {
            try
            {
                ...
                string Content = "";
                IEnumerable<ImportQoItem> cmp = PurquoService.GetAllPurQuotationItem(id);
                Content = @"<html> 
                <head>
    <style>
                table, th, td {
...
<table style = 'border: 1px solid black;border-collapse: collapse;'> ";
                ...
                foreach (ImportQoItem item in cmp)
                {
...
<br/102-A
        ...
        [HttpPost]
        public ActionResult ViewQuote(PurchaseImportQuo Cy, string id)
        {
            try
            {
                Cy.ID = id;
