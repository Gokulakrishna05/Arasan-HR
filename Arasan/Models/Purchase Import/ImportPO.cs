...
namespace Arasan.Models 
{
    public class ImportPO
    {
        ...
        //public HttpPostedFileBase Customerfileup { get; set; }
        ...
        public List<IPOItemlst> PoItemlst { get; set; }

        public List<IPOItem> PoItem { get; set; }
        public List<PODoc> doclst { get; set; }
    ...
    public class PODoc
    {
        public string Collecdoc { get; set; }
