...
{
    public class PurchaseImportQuo
    {
        public PurchaseImportQuo()
        {
            this.Brlst = new List<SelectListItem>();
            this.Suplst = new List<SelectListItem>();
            this.Curlst = new List<SelectListItem>();
            this.QoLst = new List<ImportQoItem>();
        ...
        public List<ImportQoItem> QoLst;
    ...
    //}
    public class PurchaseImportQuoItems
    {
