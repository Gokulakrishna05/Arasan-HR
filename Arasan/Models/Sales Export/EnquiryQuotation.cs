...
namespace Arasan.Models
{
    public class EnquiryQuotation
    {
        ...
        public List<QuotationItem> QuotLst { get; set; }
        public List<TermsItems> TermsList { get; set; }
    }
    ...
    public class ExportQuotationItems
    {
