...
namespace Arasan.Services
{
    public class HolidayMasterService : IHolidayMaster
    {
        ...
        public DataTable GetAllHolidayMaster(string status)
        {
            ...
            {
                SvSql = "Select HOLIDAYID,HOLIDAYNAME,HOLIDAYDATE,DAYOFWEEK,HOLIDAYMASTER.IS_ACTIVE from HOLIDAYMASTER WHERE HOLIDAYMASTER.IS_ACTIVE='N' ORDER BY HOLIDAYMASTER.HOLIDAYID DESC ";
