...
namespace Arasan.Services
{
    ...
    public IEnumerable<Branch> GetAllBranch()
    {
        ...
        using (OracleConnection con = new OracleConnection(_connectionString))
        {
            ...
            {
                con.Open();
                cmd.CommandText = "Select BRANCHMASTID,COMPANYMAST.COMPANYDESC,BRANCHID,ADDRESS1,STATE,CITY,PINCODE,CSTNO, CSTDATE from BRANCHMAST left outer join COMPANYMAST on COMPANYMASTID=BRANCHMAST.COMPANYID WHERE STATUS= 'ACTIVE' ";
