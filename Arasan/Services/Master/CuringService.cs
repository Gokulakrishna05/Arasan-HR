...
namespace Arasan.Services
{
    public class CuringService : ICuringService
    {
        ...
        public DataTable GetAllCuring(string strStatus)
        {
            ...
            {
                SvSql = "select CURINGMASTERID,LOCDETAILS.LOCID,SUBGROUP,SHEDNUMBER,CAPACITY from CURINGMASTER  LEFT OUTER JOIN LOCDETAILS ON LOCDETAILSID=CURINGMASTER.LOCATIONID WHERE CURINGMASTER.STATUS ='Active' ORDER BY CURINGMASTERID DESC ";
