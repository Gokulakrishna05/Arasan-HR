...
namespace Arasan.Services.Master
{
    public class ItemNameService : IItemNameService
    {
        ...
        public IEnumerable<ItemName> GetAllItemName()
        {
            ...
            using (OracleConnection con = new OracleConnection(_connectionString))
            {
                ...
                using (OracleCommand cmd = con.CreateCommand())
                {
                    ...
                    cmd.CommandText = "Select IGROUP,ISUBGROUP,SUBCATEGORY,ITEMCODE,ITEMID,ITEMDESC,REORDERQTY,REORDERLVL,MINSTOCKLVL,CONVERAT,UNITMAST.UNITID,HSN,SELLINGPRICE,ITEMACC,EXPYN,VALMETHOD,SERIALYN,BSTATEMENTYN,QCT,QCCOMPFLAG,LATPURPRICE,TARIFFHEADING,REJRAWMATPER,RAWMATPER,ADD1PER,ADD1,RAWMATCAT,CURINGDAY,ITEMMASTERID from ITEMMASTER ORDER BY ITEMMASTER.ITEMMASTERID DESC ";
        ...
        public DataTable GetAllItems(string status)
        {
            ...
            SvSql = "    Select ITEMMASTER.ACTIVE,ITEMMASTER.GROUPTYPE,IGROUP,ISUBGROUP,SUBCATEGORY,ITEMID,ITEMDESC,REORDERQTY,REORDERLVL,MINSTK,UNITMAST.UNITID,PRIUNIT,HSN,SELLINGPRICE,ITEMACC,EXPYN,VALMETHOD,SERIALYN,BSTATEMENTYN,QCT,QCCOMPFLAG,LATPURPRICE,TARIFFHEADING,REJRAWMATPER,RAWMATPER,ADD1PER,ADD1,RAWMATCAT,ITEMMASTERID from ITEMMASTER left outer join UNITMAST ON UNITMASTID=ITEMMASTER.PRIUNIT WHERE ITEMMASTER.ACTIVE='" + status + "' ORDER BY ITEMMASTER.ITEMMASTERID DESC ";
        ...
        public string StatusChange(string tag, int id)
        {
            ...
            try
            {
                ...
                {
                    svSQL = "UPDATE ITEMMASTER SET ACTIVE ='"+ status + "' WHERE ITEMMASTERID='" + id + "'";
