...
namespace Arasan.Services.Master
{
    public class MchineServices : IMchine 
    {
        ...
        public DataTable GetAllMachine(string status)
        {
            ...
            {
                SvSql = "Select MACHINEINFOBASICID,MCODE,MNAME,MLOCATION,MSERIALNO,MMODEL,LOCDETAILS.LOCID from MACHINEINFOBASIC left outer join LOCDETAILS ON LOCDETAILSID=MACHINEINFOBASIC.MLOCATION  WHERE MACHINEINFOBASIC.IS_ACTIVE='Y' ORDER BY MACHINEINFOBASIC.MACHINEINFOBASICID DESC ";

            }
            else
            {
                SvSql = "Select MACHINEINFOBASICID,MCODE,MNAME,MLOCATION,MSERIALNO,MMODEL,LOCDETAILS.LOCID from MACHINEINFOBASIC left outer join LOCDETAILS ON LOCDETAILSID=MACHINEINFOBASIC.MLOCATION  WHERE MACHINEINFOBASIC.IS_ACTIVE='N' ORDER BY MACHINEINFOBASIC.MACHINEINFOBASICID DESC ";
