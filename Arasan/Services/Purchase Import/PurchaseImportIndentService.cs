...
{
    public class PurchaseImportIndentService : IPurchaseImportIndent
    {
        private string? _connectionString;
        IConfiguration? _configuratio;
        DataTransactions datatrans;

        public PurchaseImportIndentService(IConfiguration _configuratio)
        {
        ...
        public string IndentCRUD(PurchaseImportIndent cy)
        {
            string msg = "";
            try
            {
