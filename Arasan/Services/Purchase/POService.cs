...
namespace Arasan.Services
{
    public class POService : IPO
    {
        ...
        public async Task<IEnumerable<POItemDetail>> GetPOItem(string id)
        {
            ...
            {
                return await db.QueryAsync<POItemDetail>("SELECT TAAIERP.ITEMMASTER.ITEMID, TAAIERP.POBASIC.GROSS, TAAIERP.POBASIC.NET, TAAIERP.POBASIC.DOCID, to_char(TAAIERP.POBASIC.DOCDATE,'dd-MON-yyyy')DOCDATE,TAAIERP.PODETAIL.PUNIT,TAAIERP.PODETAIL.QTY,TAAIERP.PODETAIL.RATE,TAAIERP.PODETAIL.AMOUNT,TAAIERP.PODETAIL.CGST,TAAIERP.PODETAIL.SGST,TAAIERP.PODETAIL.IGST, TAAIERP.POBASIC.PARTYID,TAAIERP.POBASIC.AMTINWORDS,TAAIERP.POBASIC.PAYTERMS,TAAIERP.POBASIC.DELTERMS,TAAIERP.POBASIC.DESP,TAAIERP.POBASIC.WARRTERMS FROM   TAAIERP.POBASIC, TAAIERP.PODETAIL LEFT OUTER JOIN ITEMMASTER ON ITEMMASTER.ITEMMASTERID=TAAIERP.PODETAIL.ITEMID where PODETAIL.POBASICID='" + id + "' and POBASIC.POBASICID ='" + id + "'", commandType: CommandType.Text);
            }
        }
