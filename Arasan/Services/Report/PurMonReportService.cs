...
namespace Arasan.Services
{
    public class PurMonReportService : IPurMonReport
    {
        ...
        public DataTable GetAllReport(string SFINYR, string Sdate, string Edate)
        {
            ...
            //SvSql = " Select P.PartyID , I.ItemID , U.UnitID , Sum(Decode(To_Char(Db.DocDate, 'MON'), 'APR', Dd.PriQty)) Apr, Sum(Decode(To_Char(Db.DocDate, 'MON'), 'MAY', Dd.PriQty)) May, Sum(Decode(To_Char(Db.DocDate, 'MON'), 'JUN', Dd.PriQty)) Jun , Sum(Decode(To_Char(Db.DocDate, 'MON'), 'JUL', Dd.PriQty)) Jul, Sum(Decode(To_Char(Db.DocDate, 'MON'), 'AUG', Dd.PriQty)) Aug, Sum(Decode(To_Char(Db.DocDate, 'MON'), 'SEP', Dd.PriQty)) Sep, Sum(Decode(To_Char(Db.DocDate, 'MON'), 'OCT', Dd.PriQty)) Oct, Sum(Decode(To_Char(Db.DocDate, 'MON'), 'NOV', Dd.PriQty)) Nov, Sum(Decode(To_Char(Db.DocDate, 'MON'), 'DEC', Dd.PriQty)) Dec, Sum(Decode(To_Char(Db.DocDate, 'MON'), 'JAN', Dd.PriQty)) Jan, Sum(Decode(To_Char(Db.DocDate, 'MON'), 'FEB', Dd.PriQty)) Feb, Sum(Decode(To_Char(Db.DocDate, 'MON'), 'MAR', Dd.PriQty)) Mar From DPBasic Db, DPDetail Dd , PartyMast P, ItemMaster I , UnitMast U, SelectedValues S Where Db.DPBasicID = Dd.DPBasicID And Db.PartyID = P.PartyMastID And Dd.ItemID = I.ItemMasterID And U.UnitMastID = I.PriUnit AND Db.DOCDATE BETWEEN '" + Sdate + "' AND '" + Edate + "' Group By P.PartyID , I.ItemID , U.UnitID Union Select P.PartyID , I.ItemID , U.UnitID , Sum(Decode(To_Char(Db.DocDate, 'MON'), 'APR', Dd.PriQty)) Apr , Sum(Decode(To_Char(Db.DocDate, 'MON'), 'MAY', Dd.PriQty)) May, Sum(Decode(To_Char(Db.DocDate, 'MON'), 'JUN', Dd.PriQty)) Jun, Sum(Decode(To_Char(Db.DocDate, 'MON'), 'JUL', Dd.PriQty)) Jul , Sum(Decode(To_Char(Db.DocDate, 'MON'), 'AUG', Dd.PriQty)) Aug , Sum(Decode(To_Char(Db.DocDate, 'MON'), 'SEP', Dd.PriQty)) Sep , Sum(Decode(To_Char(Db.DocDate, 'MON'), 'OCT', Dd.PriQty)) Oct, Sum(Decode(To_Char(Db.DocDate, 'MON'), 'NOV', Dd.PriQty)) Nov, Sum(Decode(To_Char(Db.DocDate, 'MON'), 'DEC', Dd.PriQty)) Dec, Sum(Decode(To_Char(Db.DocDate, 'MON'), 'JAN', Dd.PriQty)) Jan, Sum(Decode(To_Char(Db.DocDate, 'MON'), 'FEB', Dd.PriQty)) Feb, Sum(Decode(To_Char(Db.DocDate, 'MON'), 'MAR', Dd.PriQty)) Mar From grnBLbasic Db, grnBLdetail Dd , PartyMast P, ItemMaster I , UnitMast U Where Db.grnBLbasicID = Dd.grnBLbasicID And Db.PartyID = P.PartyMastID And Dd.ItemID = I.ItemMasterID And U.UnitMastID = I.PriUnit AND Db.DOCDATE BETWEEN '" + Sdate + "' AND '" + Edate + "'  Group By P.PartyID , I.ItemID , U.UnitID Union Select P.PartyID , I.ItemID , U.UnitID , Sum(Decode(To_Char(Db.DocDate, 'MON'), 'APR', Dd.PriQty)) Apr , Sum(Decode(To_Char(Db.DocDate, 'MON'), 'MAY', Dd.PriQty)) May , Sum(Decode(To_Char(Db.DocDate, 'MON'), 'JUN', Dd.PriQty)) Jun , Sum(Decode(To_Char(Db.DocDate, 'MON'), 'JUL', Dd.PriQty)) Jul, Sum(Decode(To_Char(Db.DocDate, 'MON'), 'AUG', Dd.PriQty)) Aug, Sum(Decode(To_Char(Db.DocDate, 'MON'), 'SEP', Dd.PriQty)) Sep, Sum(Decode(To_Char(Db.DocDate, 'MON'), 'OCT', Dd.PriQty)) Oct, Sum(Decode(To_Char(Db.DocDate, 'MON'), 'NOV', Dd.PriQty)) Nov, Sum(Decode(To_Char(Db.DocDate, 'MON'), 'DEC', Dd.PriQty)) Dec, Sum(Decode(To_Char(Db.DocDate, 'MON'), 'JAN', Dd.PriQty)) Jan, Sum(Decode(To_Char(Db.DocDate, 'MON'), 'FEB', Dd.PriQty)) Feb, Sum(Decode(To_Char(Db.DocDate, 'MON'), 'MAR', Dd.PriQty)) MarFrom igrnbasic Db, igrndetail Dd , PartyMast P, ItemMaster I , UnitMast U Where Db.igrnbasicID = Dd.igrnbasicID And Db.PartyID = P.PartyMastID And Dd.ItemmasterID = I.ItemMasterID And U.UnitMastID = I.PriUnit AND Db.DOCDATE BETWEEN '" + Sdate + "' AND '" + Edate + "' Group By P.PartyID , I.ItemID , U.UnitID Order By 2 , 1  ";
        ...
        public DataTable GetFinyr()
        {
            ...
            SvSql = " select SFINYR from FINYRSPLIT ";
            DataTable dtt = new DataTable();
            OracleDataAdapter adapter = new OracleDataAdapter(SvSql, _connectionString);
            OracleCommandBuilder builder = new OracleCommandBuilder(adapter);
            adapter.Fill(dtt);
