        ...
        public DataTable GetAllPurchasePartyReport(string dtFrom, string dtTo, string Branch, string Customer, string Item)
        {
            try
            {
                ...
                else
                {
                    ...
                    {
                        SvSql += " WHERE Docdate BETWEEN '" + dtFrom + "' AND '" + dtTo + "'";
                    }
                    ...
                    if (Customer != null)
                    {
                        SvSql += " WHERE PartyID='" + Customer + "'";
                    }
                   
                    if (Item != null)
                    {
                        SvSql += " WHERE ItemID='" + Item + "'";
                    }
                    //if (dtFrom != null && dtTo != null && Branch != null)
                    //{
                    //    SvSql += "WHERE Docdate BETWEEN '" + dtFrom + "' AND '" + dtTo + "' AND BranchID='" + Branch + "'";
                    //}
