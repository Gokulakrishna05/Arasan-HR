...
namespace Arasan.Services.Sales
{
    public class DebitNoteBillService : IDebitNoteBillService
    {
        ...
        public DataTable GetAllDebitNoteBill(string strStatus)
        {
            ...
            {
                SvSql = "Select  BRANCHMAST.BRANCHID,DOCID,to_char(DBNOTEBASIC.DOCDATE,'dd-MON-yyyy')DOCDATE,DBNOTEBASICID,DBNOTEBASIC.TOTDIS from DBNOTEBASIC LEFT OUTER JOIN BRANCHMAST ON BRANCHMAST.BRANCHMASTID=DBNOTEBASIC.BRANCHID WHERE DBNOTEBASIC.IS_ACTIVE = 'Y' ORDER BY DBNOTEBASIC.DBNOTEBASICID DESC ";


            }
            else
            {
                SvSql = "Select  BRANCHMAST.BRANCHID,DOCID,to_char(DBNOTEBASIC.DOCDATE,'dd-MON-yyyy')DOCDATE,DBNOTEBASICID,DBNOTEBASIC.TOTDIS from DBNOTEBASIC LEFT OUTER JOIN BRANCHMAST ON BRANCHMAST.BRANCHMASTID=DBNOTEBASIC.BRANCHID WHERE DBNOTEBASIC.IS_ACTIVE = 'N' ORDER BY DBNOTEBASIC.DBNOTEBASICID DESC ";
