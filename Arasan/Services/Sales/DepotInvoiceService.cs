...
namespace Arasan.Services
{
    public class DepotInvoiceService : IDepotInvoiceService
    {
        ...
        //        string Pid = "0";
        //        string mid = datatrans.GetDataString("select ACCOUNTNAME from PARTYMAST where PARTYMASTID='" + cy.Party + "'");
        //        DataTable dtacc = new DataTable();
        //        if (cy.statetype == "GST")
        //        {
        //            dtacc = datatrans.GetData("select ADACCOUNT,ADNAME from ADCOMPH H,ADCOMPD D where H.ADCOMPHID=D.ADCOMPHID AND H.ADSCHEME='EI-GST 18%' AND H.ACTIVE='Yes'");
        //        }
        //        else
        //        {
        //            dtacc = datatrans.GetData("select ADACCOUNT,ADNAME from ADCOMPH H,ADCOMPD D where H.ADCOMPHID=D.ADCOMPHID AND H.ADSCHEME='EI-IGST 18%' AND H.ACTIVE='Yes'");
        //        }
        //        string Grossledger = "";
        ...
        //                int idc = datatrans.GetDataId("select LASTNO from sequence where TRANSTYPE='Deinv' AND ACTIVESEQUENCE='T'");

        //                string updateCMd = " UPDATE sequence SET LASTNO ='" + (idc + 1).ToString() + "' where TRANSTYPE='Deinv' AND ACTIVESEQUENCE='T'";
        //                try
        //                {
        ...
        //                svSQL = "Insert into DEPINVOBASIC (BRANCHID,INVTYPE,DOCID,DOCDATE,REFNO,REFDATE,PARTYID,VTYPE,CUSTPO,SALVAL,RECDBY,DESPBY,INSPBY,TRANSMODE,VNO,INVDESC,TRANSP,TEMPID,TRANSLIMIT,DOCTHORUGH,RNDOFF,GROSS,NET,AMTWORDS,NARRATION,BSGST,BCGST,BIGST,BFREIGHT,BDISCOUNT,CANCEL) VALUES ('" + cy.Branch + "','" + cy.InvoType + "','" + cy.InvNo + "','" + cy.InvDate + "','" + cy.RefNo + "','" + cy.RefDate + "','" + cy.Party + "','" + cy.Vocher + "','" + cy.Customer + "','" + cy.Sales + "','" + cy.RecBy + "','" + cy.Dis + "','" + cy.Inspect + "','" + cy.Trans + "','" + cy.Vno + "','" + cy.InvoiceD + "','" + cy.TranCharger + "','" + cy.Tname + "','" + cy.Distance + "','" + cy.Doc + "','" + cy.Round + "','" + cy.Gross + "','" + cy.Net + "','" + cy.AinWords + "','" + cy.Narration + "','" + cy.sgst + "','" + cy.cgst + "','" + cy.igst + "','" + cy.FrightCharge + "','" + cy.Discount + "','T')  RETURNING DEPINVOBASICID INTO :LASTCID";
        //                OracleCommand objCmds = new OracleCommand(svSQL, objConn);
        //                objCmds.Parameters.Add("LASTCID", OracleDbType.Int64, ParameterDirection.ReturnValue);
        //                objCmds.ExecuteNonQuery();
        //                Pid = objCmds.Parameters["LASTCID"].Value.ToString();
        //            }
        //            else
        //            {
        //                svSQL = "Update DEPINVOBASIC SET  BRANCHID= '" + cy.Branch + "',INVTYPE= '" + cy.InvoType + "',DOCID='" + cy.InvNo + "',DOCDATE='" + cy.InvDate + "',REFNO='" + cy.RefNo + "',REFDATE='" + cy.RefDate + "',PARTYID='" + cy.Party + "',VTYPE='" + cy.Vocher + "',CUSTPO='" + cy.Customer + "',ORDERSAMPLE='" + cy.Ordsam + "',SALVAL='" + cy.Sales + "',RECDBY='" + cy.RecBy + "',DESPBY='" + cy.Dis + "',INSPBY='" + cy.Inspect + "',TRANSMODE='" + cy.Trans + "',VNO='" + cy.Vno + "',INVDESC='" + cy.InvoiceD + "',TRANSP='" + cy.TranCharger + "',TRANSNAME='" + cy.Tname + "',TRANSLIMIT='" + cy.Distance + "',DOCTHORUGH='" + cy.Doc + "',PACKING='" + cy.Packing + "',RNDOFF='" + cy.Round + "',GROSS='" + cy.Gross + "',NET='" + cy.Net + "',AMTWORDS='" + cy.AinWords + "',NARRATION='" + cy.Narration + "'";
        //                OracleCommand objCmds = new OracleCommand(svSQL, objConn);
        //                objCmds.ExecuteNonQuery();
        //            }
        ...
        //                            if (cp.Isvalid == "Y")
        //                            {
        //                                svSQL = "Insert into DEPINVODETAIL (DEPINVOBASICID,ITEMID,ITEMTYPE,ITEMSPEC,UNIT,SRATE,BINID,LOTYN,SERIALYN,TOSUBGRID,SUBQTY,EXCISEQTY,PRIUNIT,QTY,RATE,AMOUNT,DISCOUNT,IDISC,CDISC,TDISC,ADISC,SDISC,FREIGHT,CGSTP,SGSTP,IGSTP,CGST,SGST,IGST,TOTAMT,DRUMDESC,EXCISETYPE,TARIFFID) VALUES ('" + Pid + "','" + cp.ItemId + "','" + cp.ItemType + "','" + cp.ItemSpec + "','" + UnitId + "','" + cp.rate + "','" + cp.binid + "','YES','NO','" + cp.Quantity + "','" + cp.Quantity + "','" + cp.Quantity + "','" + cp.Unit + "','" + cp.Quantity + "','" + cp.rate + "','" + cp.Amount + "','" + cp.DiscAmount + "','" + cp.IntroDiscount + "','" + cp.CashDiscount + "','" + cp.TradeDiscount + "','" + cp.AddDiscount + "','" + cp.SpecDiscount + "','" + cp.FrigCharge + "','" + cp.CGSTP + "','" + cp.SGSTP + "','" + cp.IGSTP + "','" + cp.CGST + "','" + cp.SGST + "','" + cp.IGST + "','" + cp.TotalAmount + "','" + cp.Drumsdesc + "','INPUTS','" + cp.tarrifid + "')";
        //                                OracleCommand objCmds = new OracleCommand(svSQL, objConn);
        //                                objCmds.ExecuteNonQuery();
        //                                //////////////////////////////////Inventory Update //////////////////////////
        ...
        //                                    DataTable dt = datatrans.GetData("select * from plstockvalue where plstockvalueid='" + drumid + "'");
        //                                    svSQL = "Insert into plstockvalue (T1SOURCEID,DOCID,DOCDATE,LOTNO,MINUSQTY,DRUMNO,RATE,STOCKVALUE,ITEMID,LOCID,STOCKTRANSTYPE) VALUES ('" + Pid + "','" + cy.InvNo + "','" + cy.InvDate + "','" + dt.Rows[0]["LOTNO"].ToString() + "','" + dt.Rows[0]["PLUSQTY"].ToString() + "','" + dt.Rows[0]["DRUMNO"].ToString() + "','" + dt.Rows[0]["RATE"].ToString() + "','" + cp.CurrentStock + "','" + cp.ItemId + "','" + cy.Location + "','Ex.Invoice')";
        //                                    OracleCommand objCmdd = new OracleCommand(svSQL, objConn);
        //                                    objCmdd.ExecuteNonQuery();
        //                                    datatrans.UpdateStatus("UPDATE NEWSEQUENCE SET LASTNO ='" + (plstockvalue + 1).ToString() + "' where NAME='TRANS2'");
        //                                }
        //                                long STOCKVALUE = datatrans.GetDataIdlong("select LASTNO from NEWSEQUENCE where NAME='STOCKVALUE'");
        //                                svSQL = "Insert into STOCKVALUE (STOCKVALUEID,T1SOURCEID,PLUSORMINUS,ITEMID,DOCDATE,QTY,STOCKVALUE,MASTERID,LOCID,STOCKTRANSTYPE,BINID) VALUES ('"+ STOCKVALUE + "','" + Pid + "','m','" + cp.ItemId + "','" + cy.InvDate + "','" + cp.Quantity + "','" + cp.CurrentStock + "','" + mid + "','" + cy.Location + "','SALES','" + cp.binid + "')";
        ...
        //                                svSQL = "Insert into STOCKVALUE2 (STOCKVALUE2ID,STOCKVALUEID,DOCID,RATE,NARRATION) VALUES ('" + STOCKVALUE2 + "','" + STOCKVALUE + "','" + cy.InvNo + "','" + cp.rate + "','" + cy.Narration + "')";
        ...
        //                    else
        //                    {
        //                        svSQL = "Delete DEPINVODETAIL WHERE DEPINVOBASICID='" + cy.ID + "'";
        //                        OracleCommand objCmdd = new OracleCommand(svSQL, objConn);
        //                        objCmdd.ExecuteNonQuery();
        //                        foreach (DepotInvoiceItem cp in cy.Depotlst)
        //                        {
        ...
        //                        {
        //                            //string TermsId = datatrans.GetDataString("Select TANDCDETAILID from TANDCDETAIL where TANDC='" + cp.Terms + "' ");

        //                            if (cp.Isvalid == "Y" && cp.Terms != "0")
        //                            {
        //                                svSQL = "Insert into DEPINVOTANDC (DEPINVOBASICID,TERMSANDCONDITION) VALUES ('" + Pid + "','" + cp.Terms + "')";
        //                                OracleCommand objCmds = new OracleCommand(svSQL, objConn);
        //                                objCmds.ExecuteNonQuery();
        ...
        //                    else
        //                    {
        //                        svSQL = "Delete DEPINVOTANDC WHERE DEPINVOBASICID='" + cy.ID + "'";
        //                        OracleCommand objCmdd = new OracleCommand(svSQL, objConn);
        //                        objCmdd.ExecuteNonQuery();
        //                        foreach (TermsItem cp in cy.TermsItemlst)
        //                        {
        ...
        //                            {
        //                                svSQL = "Insert into DEPINVOSADD (DEPINVOBASICID,STYPE,SNAME,SADD1,SADD2,SADD3,SSTATE,SCITY,SPINCODE,SPHONE,SFAX,SEMAIL) VALUES ('" + Pid + "','" + cp.Areaid + "','" + cp.Receiver + "','" + cp.Add1 + "','" + cp.Add2 + "','" + cp.Add3 + "','" + cp.State + "','" + cp.City + "','" + cp.PinCode + "','" + cp.Phone + "','" + cp.Fax + "','" + cp.Email + "')";
        //                                OracleCommand objCmds = new OracleCommand(svSQL, objConn);
        //                                objCmds.ExecuteNonQuery();
        ...
        //                    else
        //                    {
        //                        svSQL = "Delete DEPINVOSADD WHERE DEPINVOBASICID='" + cy.ID + "'";
        //                        OracleCommand objCmdd = new OracleCommand(svSQL, objConn);
        //                        objCmdd.ExecuteNonQuery();
        //                        foreach (AreaItem cp in cy.AreaItemlst)
        //                        {
        ...
        //                string updateCMd = " UPDATE sequence SET LASTNO ='" + (vchn + 1).ToString() + "' where TRANSTYPE='vchsl' and LOCID=('" + cy.Location + "')";
        //                datatrans.UpdateStatus(updateCMd);
        ...
        //                svSQL = "Insert into TRANS2 (TRANS2ID,TRANS1ID,DBCR,MID,NDBAMOUNT,DBAMOUNT,NCRAMOUNT,CRAMOUNT,SLN,EXRATE,SDBAMOUNT,SCRAMOUNT,T2VCHDT,T2TYPE,T2VCHSTATUS,RCTRLFLD,CMID,RPAMOUNT) VALUES ('" + TRANS2 + "','" + TRANS1 + "','Dr','" + mid + "','" + cy.Net + "','" + cy.Net + "','0','0','1','1','" + cy.Net + "','0','" + DateTime.Now.ToString("dd-MMM-yyyy") + "','sa','N','T','" + Grossledger + "','" + cy.Net + "')";
        //                OracleCommand objCmdas = new OracleCommand(svSQL, objConn);
        //                objCmdas.ExecuteNonQuery();
        ...
        //                svSQL = "Insert into TRANS2 (TRANS2ID,TRANS1ID,DBCR,MID,NDBAMOUNT,DBAMOUNT,NCRAMOUNT,CRAMOUNT,SLN,EXRATE,SDBAMOUNT,SCRAMOUNT,T2VCHDT,T2TYPE,T2VCHSTATUS,RCTRLFLD,CMID) VALUES ('" + TRANS2G + "','" + TRANS1 + "','Cr','" + Grossledger + "','0','0','" + cy.Gross + "','" + cy.Gross + "','1','1','0','" + cy.Gross + "','" + DateTime.Now.ToString("dd-MMM-yyyy") + "','sa','N','T','" + mid + "')";
        //                OracleCommand objCmdag = new OracleCommand(svSQL, objConn);
        //                objCmdag.ExecuteNonQuery();
        ...
        //                    svSQL = "Insert into TRANS2 (TRANS2ID,TRANS1ID,DBCR,MID,NDBAMOUNT,DBAMOUNT,NCRAMOUNT,CRAMOUNT,SLN,EXRATE,SDBAMOUNT,SCRAMOUNT,T2VCHDT,T2TYPE,T2VCHSTATUS,RCTRLFLD,CMID) VALUES ('" + TRANS2D + "','" + TRANS1 + "','Dr','" + discledger + "','" + cy.Discount + "','" + cy.Discount + "','0','0','1','1','" + cy.Net + "','0','" + DateTime.Now.ToString("dd-MMM-yyyy") + "','sa','N','T','" + mid + "')";
        ...
        //                    svSQL = "Insert into TRANS2 (TRANS2ID,TRANS1ID,DBCR,MID,NDBAMOUNT,DBAMOUNT,NCRAMOUNT,CRAMOUNT,SLN,EXRATE,SDBAMOUNT,SCRAMOUNT,T2VCHDT,T2TYPE,T2VCHSTATUS,RCTRLFLD,CMID) VALUES ('" + TRANS2F + "','" + TRANS1 + "','Cr','" + frieghtledger + "','0','0','" + cy.FrightCharge + "','" + cy.FrightCharge + "','1','1','0','" + cy.FrightCharge + "','" + DateTime.Now.ToString("dd-MMM-yyyy") + "','sa','N','T','" + mid + "')";
        //                    OracleCommand objCmdaf = new OracleCommand(svSQL, objConn);
        //                    objCmdaf.ExecuteNonQuery();
        ...
        //                    svSQL = "Insert into TRANS2 (TRANS2ID,TRANS1ID,DBCR,MID,NDBAMOUNT,DBAMOUNT,NCRAMOUNT,CRAMOUNT,SLN,EXRATE,SDBAMOUNT,SCRAMOUNT,T2VCHDT,T2TYPE,T2VCHSTATUS,RCTRLFLD,CMID) VALUES ('" + TRANS2C + "','" + TRANS1 + "','Cr','" + cgstledger + "','0','0','" + cy.cgst + "','" + cy.cgst + "','1','1','0','" + cy.cgst + "','" + DateTime.Now.ToString("dd-MMM-yyyy") + "','sa','N','T','" + mid + "')";
        //                    OracleCommand objCmdaf = new OracleCommand(svSQL, objConn);
        //                    objCmdaf.ExecuteNonQuery();
        ...
        //                    svSQL = "Insert into TRANS2 (TRANS2ID,TRANS1ID,DBCR,MID,NDBAMOUNT,DBAMOUNT,NCRAMOUNT,CRAMOUNT,SLN,EXRATE,SDBAMOUNT,SCRAMOUNT,T2VCHDT,T2TYPE,T2VCHSTATUS,RCTRLFLD,CMID) VALUES ('" + TRANS2S + "','" + TRANS1 + "','Cr','" + sgstledger + "','0','0','" + cy.sgst + "','" + cy.sgst + "','1','1','0','" + cy.sgst + "','" + DateTime.Now.ToString("dd-MMM-yyyy") + "','sa','N','T','" + mid + "')";
        //                    OracleCommand objCmdaf = new OracleCommand(svSQL, objConn);
        //                    objCmdaf.ExecuteNonQuery();
        ...
        //                    svSQL = "Insert into TRANS2 (TRANS2ID,TRANS1ID,DBCR,MID,NDBAMOUNT,DBAMOUNT,NCRAMOUNT,CRAMOUNT,SLN,EXRATE,SDBAMOUNT,SCRAMOUNT,T2VCHDT,T2TYPE,T2VCHSTATUS,RCTRLFLD,CMID) VALUES ('" + TRANS2I + "','" + TRANS1 + "','Cr','" + igstledger + "','0','0','" + cy.igst + "','" + cy.igst + "','1','1','0','" + cy.igst + "','" + DateTime.Now.ToString("dd-MMM-yyyy") + "','sa','N','T','" + mid + "')";
        //                    OracleCommand objCmdaf = new OracleCommand(svSQL, objConn);
        //                    objCmdaf.ExecuteNonQuery();
        ...
        //                    svSQL = "Insert into TRANS2 (TRANS2ID,TRANS1ID,DBCR,MID,NDBAMOUNT,DBAMOUNT,NCRAMOUNT,CRAMOUNT,SLN,EXRATE,SDBAMOUNT,SCRAMOUNT,T2VCHDT,T2TYPE,T2VCHSTATUS,RCTRLFLD,CMID) VALUES ('" + TRANS2R + "','" + TRANS1 + "','Cr','" + roundoffledger + "','0','0','" + cy.Round + "','" + cy.Round + "','1','1','0','" + cy.Round + "','" + DateTime.Now.ToString("dd-MMM-yyyy") + "','sa','N','T','" + mid + "')";
        //                    OracleCommand objCmdaf = new OracleCommand(svSQL, objConn);
        //                    objCmdaf.ExecuteNonQuery();
