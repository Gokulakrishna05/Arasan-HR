...
namespace Arasan.Services
{
    public class PurchaseReturnService : IPurchaseReturn
    {
        ...
        public DataTable GetAllPurchaseReturnItems(string strStatus)
        {
            ...
            {
                SvSql = "Select PARTYMAST.PARTYNAME,PRETBASIC.DOCID,to_char(PRETBASIC.DOCDATE,'dd-MON-yyyy') DOCDATE,PRETBASIC.EXCHANGERATE,PRETBASIC.REFNO,to_char(PRETBASIC.REFDT,'dd-MON-yyyy')REFDT,PRETBASIC.LOCID,PRETBASIC.REJBY,PRETBASIC.TRANSITLOCID,PRETBASIC.TEMPFIELD,CURRENCY.MAINCURR,PRETBASIC.RGRNNO,PRETBASIC.GROSS,PRETBASIC.NET,PRETBASIC.NARR,PRETBASICID,PRETBASIC.IS_ACTIVE,PRETBASIC.STATUS from PRETBASIC LEFT OUTER JOIN PARTYMAST ON PARTYMAST.PARTYMASTID=PRETBASIC.PARTYID LEFT OUTER JOIN CURRENCY ON CURRENCY.CURRENCYID=PRETBASIC.MAINCURRENCY  AND PRETBASIC.IS_ACTIVE='Y' ORDER BY PRETBASIC.PRETBASICID DESC";
            }
            else
            {
                SvSql = "Select PARTYMAST.PARTYNAME,PRETBASIC.DOCID,to_char(PRETBASIC.DOCDATE,'dd-MON-yyyy') DOCDATE,PRETBASIC.EXCHANGERATE,PRETBASIC.REFNO,to_char(PRETBASIC.REFDT,'dd-MON-yyyy')REFDT,PRETBASIC.LOCID,PRETBASIC.REJBY,PRETBASIC.TRANSITLOCID,PRETBASIC.TEMPFIELD,CURRENCY.MAINCURR,PRETBASIC.RGRNNO,PRETBASIC.GROSS,PRETBASIC.NET,PRETBASIC.NARR,PRETBASICID,PRETBASIC.IS_ACTIVE,PRETBASIC.STATUS from PRETBASIC LEFT OUTER JOIN PARTYMAST ON PARTYMAST.PARTYMASTID=PRETBASIC.PARTYID LEFT OUTER JOIN CURRENCY ON CURRENCY.CURRENCYID=PRETBASIC.MAINCURRENCY  AND PRETBASIC.IS_ACTIVE='N' ORDER BY PRETBASIC.PRETBASICID DESC";
            }
            DataTable dtt = new DataTable();
            OracleDataAdapter adapter = new OracleDataAdapter(SvSql, _connectionString);
            OracleCommandBuilder builder = new OracleCommandBuilder(adapter);
