...
namespace Arasan.Services.Store_Management
{
    public class SubContractingDCService : ISubContractingDC
    {
        ...
        public async Task<IEnumerable<Subcondcdet>> GetSubcondc(string id )
        {
            ...
            {
                return await db.QueryAsync<Subcondcdet>("SELECT SUBCONTDCBASIC.SUBCONTDCBASICID, SUBCONTDCBASIC.BRANCH, to_char(SUBCONTDCBASIC.DOCDATE,'dd-MM-yy')DOCDATE, SUBCONTDCBASIC.DOCID, SUBCONTDCBASIC.REFNO, SUBCONTDCBASIC.WCID, SUBCONTDCBASIC.FROMLOCATION, SUBCONTDCBASIC.ENTEREDBY, SUBCONTDCBASIC.NARRATION, SUBCONTDCBASIC.LOCID, SUBCONTDCBASIC.TOTQTY, SUBCONTDCBASIC.TOTRECQTY, SUBCONTDCBASIC.EBY, SUBCONTDCBASIC.USERID, PARTYMAST.PARTYID,  SUBCONTDCBASIC.PARTYMASTID, SUBCONTDCBASIC.TOLOCATION, SUBCONTDCBASIC.LOCDETAILSID, SUBCONTDCBASIC.ADD1 ||','||SUBCONTDCBASIC.ADD2 ||','||SUBCONTDCBASIC.CITY ||'-'||PARTYMAST.PINCODE as ADDRESS, SUBCONTDCBASIC.THROUGH, SUBCONTDCDETAIL.SUBCONTDCDETAILID, SUBCONTDCDETAIL.SUBCONTDCBASICID AS EXPR2, ITEMMASTER.ITEMID,ITEMMASTER.HSN, SUBCONTDCDETAIL.UNIT, SUBCONTDCDETAIL.QTY,SUBCONTDCDETAIL.NOOFBAGS,PARTYMAST.GSTNO, SUBCONTDCDETAIL.RATE, SUBCONTDCDETAIL.AMOUNT, SUBCONTEDET.SUBCONTEDETID,SUBCONTEDET.SUBCONTDCBASICID AS EXPR3, SUBCONTEDET.RITEM, SUBCONTEDET.RITEMMASTERID, SUBCONTEDET.RUNIT, SUBCONTEDET.ERATE, SUBCONTEDET.EAMOUNT, SUBCONTEDET.ERQTY, SUBCONTEDET.APPRATE, SUBCONTEDET.EFRATE, SUBCONTEDET.RSUBQTY, SUBCONTEDET.RECQTY FROM SUBCONTDCBASIC  INNER JOIN PARTYMAST ON PARTYMAST.PARTYMASTID =SUBCONTDCBASIC.PARTYID INNER JOIN SUBCONTDCDETAIL ON SUBCONTDCBASIC.SUBCONTDCBASICID = SUBCONTDCDETAIL.SUBCONTDCBASICID  INNER JOIN SUBCONTEDET ON SUBCONTDCBASIC.SUBCONTDCBASICID = SUBCONTEDET.SUBCONTDCBASICID INNER JOIN ITEMMASTER ON ITEMMASTER.ITEMMASTERID =SUBCONTDCDETAIL.ITEMID where SUBCONTDCBASIC.SUBCONTDCBASICID='" + id + "' and SUBCONTEDET.SUBCONTDCBASICID ='" + id + "' and SUBCONTDCDETAIL.SUBCONTDCBASICID ='" + id + "'", commandType: CommandType.Text);
            }
        }
        ...
        public async Task<IEnumerable<Subcondcdetet>> GetSubcondcdet(string id)
        {
            using (OracleConnection db = new OracleConnection(_connectionString))
            {
                return await db.QueryAsync<Subcondcdetet>(" SELECT  SUBCONTEDET.SUBCONTEDETID,SUBCONTEDET.SUBCONTDCBASICID AS EXPR3, ITEMMASTER.ITEMID, SUBCONTEDET.RITEMMASTERID, SUBCONTEDET.RUNIT, SUBCONTEDET.ERATE, SUBCONTEDET.EAMOUNT, SUBCONTEDET.APPRATE, SUBCONTEDET.EFRATE, SUBCONTEDET.RSUBQTY, SUBCONTEDET.ERQTY,ITEMMASTER.HSN FROM SUBCONTDCBASIC INNER JOIN SUBCONTEDET ON SUBCONTDCBASIC.SUBCONTDCBASICID = SUBCONTEDET.SUBCONTDCBASICID  INNER JOIN ITEMMASTER ON ITEMMASTER.ITEMMASTERID = SUBCONTEDET.RITEM where SUBCONTEDET.SUBCONTDCBASICID ='" + id + "'", commandType: CommandType.Text);
            }
        }
